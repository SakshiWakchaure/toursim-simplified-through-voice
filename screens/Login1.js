...
<section className="vh-100" style="background-color:#071635;">
    <div className="container py-5 h-100">
    <div className="row d-flex justify-content-center align-items-center h-100">
    <div className="col col-xl-10">
    <div className="card" style="border-radius: 1rem; background-color:#2B2D42">
    ...
    <h5 className="fw-normal text-white mb-3 pb-3" style="letter-spacing: 1px;">Log into your account</h5>
